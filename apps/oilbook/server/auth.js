...
export function seedAdmin() {
  ...
  if (n > 0) return;
  // No hardcoded password in source: use SEED_ADMIN_PASSWORD, else generate a
  // random one and print it once so the credential never lives in the repo.
  ...
  console.log(`\n⚠  Seeded default admin account → username: admin  password: ${generated ? password : '(from SEED_ADMIN_PASSWORD)'}`);
