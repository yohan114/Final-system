...
- ⏸ **Battery / store cost categories** — investigated and deferred: S4 batteries carry no cost field (needs a schema addition first) and S3 store issues are free-text-only (would land in the unattributed bucket). Revisit once batteries carry a purchase cost.
