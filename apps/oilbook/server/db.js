...
// Battery lifecycle (warranty + expected-replacement alerts, and unit cost for
// future per-vehicle battery costing).
addColumn('batteries', 'installed_date', 'installed_date TEXT');
addColumn('batteries', 'warranty_months', 'warranty_months INTEGER');
addColumn('batteries', 'unit_cost', 'unit_cost REAL');
